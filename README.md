...
### LayoutGPT
For layoutgpt, please refer to https://github.com/weixi-feng/LayoutGPT for enviornment setup and related script.
Due to API limits and accessibility issues, all layouts were generated by providing LayoutGPT's prompt to ChatGPT-4o.